...
def test_quiz(client):
    ...
    # check all sets
    client.post('/quiz/select_sets', data={'set_ids': [set_id_a, set_id_b, set_id_c]}, follow_redirects=True)
    ...
    # check set a & c
    client.post('/quiz/select_sets', data={'set_ids': [set_id_a, set_id_c]}, follow_redirects=True)
    ...
    # check set b
    client.post('/quiz/select_sets', data={'set_ids': [set_id_b]}, follow_redirects=True)
...
def test_multiuser_quiz(client):
    ...
    # check all sets
    client.post('/quiz/select_sets', data={'set_ids': [set_id_x, set_id_b, set_id_y]}, follow_redirects=True)
    ...
    client.post('/quiz/select_sets', data={'set_ids': [set_id_x, set_id_b, set_id_z]}, follow_redirects=True)
